...
max_num_object = 250 # maximum number of observed objects is 70
...
if __name__ == '__main__':
	...
	test_file_path_list = sorted(glob.glob(os.path.join(data_root, 'history_v.txt')))
